...
#character_map = ['D ', '  ', 'W ']
character_map = ['\xf0\x9f\x92\xa9 ', ' ', 'W ']
...
class VacuumWorld():
    ...
    def __init__(self):
        ...
        self.grid = np.random.randint(3, size=(self.width, self.height))
    ...
    def update(self, action):
        ...
        if action == 'off':
            ...
            new_x = np.clip(self.x + dx, 0, self.width)
            new_y = np.clip(self.y + dy, 0, self.height)
